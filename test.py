...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='efgtnet', help='model name [default: efgtnet]')
    ...
    parser.add_argument('--log_dir', type=str, default='efgtnet', help='experiment root')
    ...
    with torch.no_grad():
        ...
        for i, (points, target, scene_name) in tqdm(enumerate(testDataLoader), total=len(testDataLoader),
            ...
            if args.visualize:
                ...
                pc_vector_colors = np.concatenate(
                    (pc_vector_colors, np.zeros_like(pc_vector_colors), np.zeros_like(pc_vector_colors)), axis=1)
            ...
            print(
                "mae:{}, iou_sum:{}, fmeasure_sum:{}, emeasure_sum:{}".format(mae, iou_sum, fmeasure_sum, emeasure_sum))
